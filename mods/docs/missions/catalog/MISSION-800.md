...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 5056 | GotoLocation | — | — | 5057 | — | — | 1931 |
| 5057 | GotoLocation | — | — | 5058 | — | — | 2311 |
| 5058 | Talk | — | — | 5059 | — | — | 737 |
| 5059 | Talk | — | — | — | — | — | 736 |
...
- Complete at terminator NPC table ID **1931** (proximity/talk).
...
- `iTaskNum` = 5056
- `iNPC_ID` = runtime ID from terminator NPC 1931
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown

### Journal summary

Team up with the Toiletnator.
