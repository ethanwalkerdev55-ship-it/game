# Mission 353 — Dark Engine Days (Part 3 of 4)
...
**Tags:** kill-quota, item-quota, chains-to=1939

### How this task is received

- Player accepts from NPC table ID **733** via journal (`cnEvent(12,5)`).
- Prerequisite completed mission **352**.
...
- Collect items: item 492 x8
- Reward table ID **442** (journal reward UI before `TASK_END`).
