# Mission 217 — Welcome to Endsville (Part 5 of 6)
...
Obtain Eduardo's stuffed animal.
...
- Collect items: item 189 x1
- Reward table ID **158** (journal reward UI before `TASK_END`).
