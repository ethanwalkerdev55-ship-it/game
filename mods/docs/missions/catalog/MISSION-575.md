...
**Tags:** kill-quota, item-quota, chains-to=2294

### How this task is received

- Player accepts from NPC table ID **751** via journal (`cnEvent(12,5)`).
- Prerequisite completed mission **642**.
...
Collect a Meteoric Sentry's tendril.
...
- Reward table ID **545** (journal reward UI before `TASK_END`).
