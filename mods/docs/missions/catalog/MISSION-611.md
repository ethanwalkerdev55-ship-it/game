# Mission 611 — Head to Totem (Part 1 of 5)
...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 1579 | GotoLocation | — | — | 2324 | — | 738 | 2268 |
| 2324 | UseItems | — | — | 2325 | — | — | 2826 |
| 2325 | Talk | — | — | — | — | — | 738 |
...
Activate the totem in the Crystalline Caverns.
...
- Complete at terminator NPC table ID **2826** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 2324
- `iNPC_ID` = runtime ID from terminator NPC 2826
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
...
- Reward table ID **558** (journal reward UI before `TASK_END`).
