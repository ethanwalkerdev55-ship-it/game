# Mission 677 — Fusion Assembly Line (Part 2 of 5)
...
Stop the Skull Crushers in the Dark Glade.
...
- Reward table ID **610** (journal reward UI before `TASK_END`).
