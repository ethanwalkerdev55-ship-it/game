# Mission 739 — LOCONUT (Part 4 of 5)
...
Return to Numbuh 621 to see about the LOCONUT.

## Task 2575

**Tags:** kill-quota, chains-to=2576
...
- Reward table ID **650** (journal reward UI before `TASK_END`).
