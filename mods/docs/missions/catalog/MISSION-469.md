# Mission 469 — A History of Planet Fusion (Part 1 of 4)
...
**Tags:** kill-quota, item-quota, chains-to=2136
...
- Kill quotas: enemy 407 x0
- Collect items: item 533 x1
...
- Start: auto-chain or journal (no grant NPC table ID).
- Complete at terminator NPC table ID **732** (proximity/talk).
- Reward table ID **491** (journal reward UI before `TASK_END`).
