# Mission 232 — Tech Square Titans (Part 3 of 4)
...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 2192 | GotoLocation | — | — | 2193 | — | 2562 | 2364 |
| 2193 | Talk | — | — | 2194 | — | — | 729 |
| 2194 | Talk | — | — | — | — | — | 2562 |
...
- Complete at terminator NPC table ID **2364** (proximity/talk).
...
- `iTaskNum` = 2192
- `iNPC_ID` = runtime ID from terminator NPC 2364
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown

### Journal summary

Obtain Mandark's glasses.
...
- Reward table ID **513** (journal reward UI before `TASK_END`).
