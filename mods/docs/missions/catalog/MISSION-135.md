...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 1693 | GotoLocation | — | — | 1694 | — | 752 | 2161 |
| 1694 | UseItems | — | — | 1695 | — | — | 2208 |
| 1695 | Talk | — | — | 1696 | — | — | 707 |
| 1696 | Talk | — | — | — | — | — | 746 |
...
- Prerequisite completed mission **134**.
...
- Complete at terminator NPC table ID **2208** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 1694
- `iNPC_ID` = runtime ID from terminator NPC 2208
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
...
- Reward table ID **389** (journal reward UI before `TASK_END`).
