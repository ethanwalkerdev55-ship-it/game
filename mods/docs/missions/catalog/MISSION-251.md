# Mission 251 — Completing the Project (Part 3 of 3)
...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 2261 | GotoLocation | — | — | 2262 | — | 779 | 2754 |
| 2262 | Talk | — | — | 2263 | — | — | 751 |
| 2263 | Talk | — | — | — | — | — | 779 |
...
- Complete at terminator NPC table ID **2754** (proximity/talk).
...
- `iTaskNum` = 2261
- `iNPC_ID` = runtime ID from terminator NPC 2754
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown

### Journal summary

Obtain Demongo's skull.
...
- Reward table ID **534** (journal reward UI before `TASK_END`).
