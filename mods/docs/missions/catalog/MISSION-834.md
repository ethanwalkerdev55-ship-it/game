...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 5178 | Talk | — | — | 5179 | — | 709 | 3130 |
| 5179 | GotoLocation | — | — | 5180 | — | — | 1225 |
| 5180 | Talk | — | — | 5181 | — | — | 718 |
| 5181 | Talk | — | — | 5182 | — | — | 709 |
| 5182 | GotoLocation | — | — | 5183 | — | — | 3131 |
| 5183 | Talk | — | — | — | — | — | 709 |
...
Help Father use time travel to recruit the adult versions of Sector V.
...
- Complete at terminator NPC table ID **1225** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 5179
- `iNPC_ID` = runtime ID from terminator NPC 1225
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
...
- Task type: **GotoLocation**
- Start: auto-chain or journal (no grant NPC table ID).
- Complete at terminator NPC table ID **3131** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 5182
- `iNPC_ID` = runtime ID from terminator NPC 3131
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
