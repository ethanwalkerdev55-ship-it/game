# Mission 352 — Dark Engine Days (Part 2 of 4)
...
**Tags:** kill-quota, item-quota, chains-to=1937

### How this task is received

- Player accepts from NPC table ID **733** via journal (`cnEvent(12,5)`).
- Prerequisite completed mission **351**.
...
Defeat the Oil Ogres in Steam Alley.
...
- Collect items: item 491 x5
- Reward table ID **441** (journal reward UI before `TASK_END`).
