# Mission 355 — Bet on Ben (Part 1 of 5)
...
**Tags:** kill-quota, chains-to=1941
...
Protect the Spaceport.

## Task 1941

**Tags:** kill-quota, chains-to=2210
...
- Reward table ID **443** (journal reward UI before `TASK_END`).
