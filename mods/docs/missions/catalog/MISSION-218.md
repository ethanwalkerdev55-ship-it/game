# Mission 218 — Peach Creek to Foster's (Part 3 of 5)
...
- Collect items: item 190 x1
- Reward table ID **159** (journal reward UI before `TASK_END`).
