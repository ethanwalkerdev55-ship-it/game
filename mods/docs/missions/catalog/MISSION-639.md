# Mission 639 — Demonic Business (Part 1 of 4)
...
**Tags:** kill-quota, chains-to=2376
...
- Reward table ID **582** (journal reward UI before `TASK_END`).
