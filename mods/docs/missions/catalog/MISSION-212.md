# Mission 212 — Peach Creek to Foster's (Part 2 of 5)
...
- Collect items: item 184 x1
- Reward table ID **153** (journal reward UI before `TASK_END`).
