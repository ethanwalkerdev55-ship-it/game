# Mission 210 — Genius Groves, Candy Coves (Part 1 of 5)
...
- Complete at terminator NPC table ID **1022** (proximity/talk).
...
- `iTaskNum` = 526
- `iNPC_ID` = runtime ID from terminator NPC 1022
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown

### Journal summary

Obtain Dee Dee's Pony Puff Princess doll.
...
- Reward table ID **122** (journal reward UI before `TASK_END`).
