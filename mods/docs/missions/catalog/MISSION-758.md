...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 2649 | GotoLocation | — | — | 2650 | — | 2148 | 2798 |
| 2650 | UseItems | — | — | 2651 | — | — | 3239 |
| 2651 | Talk | — | — | — | — | — | 2148 |
...
Gather information on the Large Spore Pod.
...
- Complete at terminator NPC table ID **3239** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 2650
- `iNPC_ID` = runtime ID from terminator NPC 3239
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
...
- Reward table ID **670** (journal reward UI before `TASK_END`).
