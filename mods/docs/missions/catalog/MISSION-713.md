# Mission 713 — SACT Attack (Part 1 of 4)
...
**Tags:** kill-quota, chains-to=2497
...
Defeat Cavern Wolves near SACT positions.
...
- Reward table ID **631** (journal reward UI before `TASK_END`).
