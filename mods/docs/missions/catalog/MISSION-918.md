# Mission 918 — Ancient Evils (Part 1 of 2)
...
Recover King Ramses' slab for courage.
...
- Collect items: item 575 x1
- Reward table ID **721** (journal reward UI before `TASK_END`).
