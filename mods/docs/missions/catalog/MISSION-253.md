# Mission 253 — Helping Numbuh Two (Part 1 of 3)
...
**Tags:** kill-quota, chains-to=1467
...
Defend the tree house from Sneaky Spawns.
...
- Reward table ID **171** (journal reward UI before `TASK_END`).
