# Mission 605 — The Book of Prophecy (Part 5 of 5)
...
- Prerequisite completed mission **604**.
...
Charm May Kanker into giving up the Book of Prophecy.
...
- Reward table ID **553** (journal reward UI before `TASK_END`).
