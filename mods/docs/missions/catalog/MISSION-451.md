# Mission 451 — Scotsman's Best Friend (Part 1 of 3)
...
**Tags:** kill-quota, chains-to=1400
...
Defeat Asphalt Freaks in the park.
...
- Collect items: item 355 x1
- Reward table ID **316** (journal reward UI before `TASK_END`).
