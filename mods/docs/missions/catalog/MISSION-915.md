# Mission 915 — Knishmas Kapers (Part 7 of 8)
...
- Prerequisite completed mission **914**.
...
Find the present thief in Huntor's Crest
...
- Reward table ID **697** (journal reward UI before `TASK_END`).
