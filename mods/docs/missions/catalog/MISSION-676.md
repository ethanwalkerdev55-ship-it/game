# Mission 676 — Fusion Assembly Line (Part 1 of 5)
...
**Tags:** kill-quota, chains-to=2436
...
Stop Fuse's perfect Fusion plans.
...
- Reward table ID **609** (journal reward UI before `TASK_END`).
