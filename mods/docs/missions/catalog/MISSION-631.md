# Mission 631 — Building a Master Arsenal (Part 2 of 4)
...
- Prerequisite completed mission **630**.
...
- Reward table ID **575** (journal reward UI before `TASK_END`).
