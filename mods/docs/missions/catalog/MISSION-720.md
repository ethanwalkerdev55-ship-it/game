# Mission 720 — Faux Coco (Part 1 of 3)
...
**Tags:** kill-quota, item-quota, chains-to=2523
...
- Kill quotas: enemy 193 x0
- Collect items: item 552 x6
...
- Reward table ID **638** (journal reward UI before `TASK_END`).
