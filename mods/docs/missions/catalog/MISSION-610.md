# Mission 610 — A Rune with a View (Part 5 of 5)
...
- Prerequisite completed mission **609**.
...
Take the Spine of the Book of Prophecy to Grim to see if he can translate the runes.
...
- Reward table ID **557** (journal reward UI before `TASK_END`).
