# Mission 444 — Water You Kidding? (Part 1 of 4)
...
**Tags:** kill-quota, item-quota, chains-to=1369
...
- Collect items: item 347 x3
- Reward table ID **309** (journal reward UI before `TASK_END`).
