...
- Prerequisite completed mission **147**.
...
Find the Plumber base access port in Peach Creek.
...
- Reward table ID **30** (journal reward UI before `TASK_END`).
