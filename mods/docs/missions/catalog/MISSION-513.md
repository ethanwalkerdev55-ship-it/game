...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 555 | GotoLocation | — | — | 556 | — | 771 | 1080 |
| 556 | UseItems | — | — | 557 | — | — | 1062 |
| 557 | Talk | — | — | — | — | — | 771 |
...
Help Mandark stabilize the power grid.
...
- Complete at terminator NPC table ID **1062** (proximity/talk).
...
**End packet** (`sP_CL2FE_REQ_PC_TASK_END`, opcode 318767116):
- `iTaskNum` = 556
- `iNPC_ID` = runtime ID from terminator NPC 1062
- `iEscortNPC_ID` = escort runtime or **-1** if `bError=true`
- `iBox1Choice` / `iBox2Choice` = reward bits if reward UI shown
...
- Reward table ID **129** (journal reward UI before `TASK_END`).
