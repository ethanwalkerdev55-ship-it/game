...
|---------|------|----------|--------|-----------|--------|-----------|------------|
| 204 | Talk | — | — | 205 | — | 703 | 702 |
| 205 | GotoLocation | — | — | 206 | — | — | 914 |
| 206 | Defeat | — | — | 207 | — | — | — |
| 207 | Delivery | — | — | 208 | — | — | 702 |
| 208 | Delivery | — | — | — | — | — | 703 |
...
- Prerequisite completed mission **150**.
...
Find the Professor and discuss Buttercup's disappearance.
...
**Tags:** kill-quota, item-quota, chains-to=207
...
- Kill quotas: enemy 305 x0
- Collect items: item 67 x1
...
- Collect items: item 67 x1
- Reward table ID **52** (journal reward UI before `TASK_END`).
