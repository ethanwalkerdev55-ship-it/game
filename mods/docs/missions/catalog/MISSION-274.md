# Mission 274 — Laboratory Safety (Part 1 of 3)
...
Help protect Dee Dee's house.

## Task 804

**Tags:** kill-quota, chains-to=2099
...
- Reward table ID **191** (journal reward UI before `TASK_END`).
