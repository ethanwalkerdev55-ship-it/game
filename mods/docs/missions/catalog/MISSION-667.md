# Mission 667 — Nano Corruption Commotion (Part 2 of 6)
...
Protect Mojo from Doom Diggers.
...
- Reward table ID **507** (journal reward UI before `TASK_END`).
