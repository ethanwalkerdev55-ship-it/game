# Mission 654 — Planetoid Fusion (Part 5 of 5)
...
- Prerequisite completed mission **653**.

### How this task must be completed

- Task type: **UseItems**
- Start at grant NPC table ID **728** (journal accept or auto-chain).
- Complete at terminator NPC table ID **3041** (proximity/talk).
...
- `iTaskNum` = 2401
- `iNPC_ID` = runtime ID from terminator NPC 3041
...
- Reward table ID **594** (journal reward UI before `TASK_END`).
