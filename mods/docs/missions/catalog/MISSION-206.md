# Mission 206 — Peach Creek to Foster's (Part 1 of 5)
...
- Collect items: item 151 x1
- Reward table ID **118** (journal reward UI before `TASK_END`).
